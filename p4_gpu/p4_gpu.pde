...
void draw() {
  ...
  for (int x = -300; x < -50; x += 5) {
    for (int y = 50; y < 300; y += 5) {
      beginShape();
      texture(bumps_texture);
      vertex(x, y, -300, (x + 300)/250.0, (y - 50)/ 250.0);
      vertex(x + 5, y, -300, (x + 5 + 300)/250.0, (y - 50)/250.0);
      vertex(x + 5, y + 5, -300, (x + 5 + 300)/250.0, (y + 5 - 50)/250.0);
      vertex(x, y + 5, -300, (x + 300)/250.0, (y + 5 - 50)/250.0);
      endShape();
    }
  }
  popMatrix();
